...
class UnitTests(unittest.TestCase):
	...
	def test_kitchenSink(self):
		...
		tracking_settings.set_open_tracking(
			OpenTracking(True, "Optional tag to replace with the open image in the body of the message"))
		tracking_settings.set_subscription_tracking(
			SubscriptionTracking(True, "text to insert into the text/plain portion of the message",
		...
		tracking_settings.set_ganalytics(
			Ganalytics(True, "some source", "some medium", "some term", "some content", "some campaign"))
