...
class UnitTests(unittest.TestCase):
	...
	def setUpClass(cls):
		...
		if os.path.isfile('/usr/local/bin/prism') == False:
			if sys.platform != 'win32':
				...
				print(
				"Please download the Windows binary (https://github.com/stoplightio/prism/releases) and place it in your /usr/local/bin directory")
				sys.exit()
	...
	def test_asm_groups__group_id__suppressions_search_post(self):
		...
		group_id = "test_url_param"
		headers = {'X-Mock': 200}
		response = self.sg.client.asm.groups._(group_id).suppressions.search.post(request_body=data,
	...
	def test_browsers_stats_get(self):
		params = {'end_date': '2016-04-01', 'aggregated_by': 'day', 'browsers': 'test_string', 'limit': 'test_string',
	...
	def test_categories_stats_get(self):
		params = {'end_date': '2016-04-01', 'aggregated_by': 'day', 'limit': 1, 'offset': 1, 'start_date': '2016-01-01',
	...
	def test_categories_stats_sums_get(self):
		params = {'end_date': '2016-04-01', 'aggregated_by': 'day', 'limit': 1, 'sort_by_metric': 'test_string',
				  'offset': 1, 'start_date': '2016-01-01', 'sort_by_direction': 'asc'}
		headers = {'X-Mock': 200}
	...
	def test_mailbox_providers_stats_get(self):
		params = {'end_date': '2016-04-01', 'mailbox_providers': 'test_string', 'aggregated_by': 'day', 'limit': 1,
				  'offset': 1, 'start_date': '2016-01-01'}
		headers = {'X-Mock': 200}
	...
	def test_subusers_stats_monthly_get(self):
		params = {'subuser': 'test_string', 'limit': 1, 'sort_by_metric': 'test_string', 'offset': 1,
				  'date': 'test_string', 'sort_by_direction': 'asc'}
		headers = {'X-Mock': 200}
	...
	def test_subusers__subuser_name__stats_monthly_get(self):
		params = {'date': 'test_string', 'sort_by_direction': 'asc', 'limit': 1, 'sort_by_metric': 'test_string',
				  'offset': 1}
		subuser_name = "test_url_param"
		headers = {'X-Mock': 200}
	...
	def test_user_webhooks_parse_settings__hostname__patch(self):
		...
		headers = {'X-Mock': 200}
		response = self.sg.client.user.webhooks.parse.settings._(hostname).patch(request_body=data,
																				 request_headers=headers)
		self.assertEqual(response.status_code, 200)
	...
	def test_user_webhooks_parse_stats_get(self):
		params = {'aggregated_by': 'day', 'limit': 'test_string', 'start_date': '2016-01-01', 'end_date': '2016-04-01',
				  'offset': 'test_string'}
		headers = {'X-Mock': 200}
	...
	def test_whitelabel_domains_get(self):
		params = {'username': 'test_string', 'domain': 'test_string', 'exclude_subusers': 'true', 'limit': 1,
				  'offset': 1}
		headers = {'X-Mock': 200}
